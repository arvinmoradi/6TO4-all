...
**تغییراتی در ipsec انجام شد و همچنین سرویس ریست تایمر اضافه شد. میتوانید هم چنین به صورت دلخواه ویرایش نمایید**

**اپدیت ویرایش سرور و 10 سرور و ipsec کامل شد- آموزش ویرایش سرور قرار داده شد**

**محاسبه ریاضی اتوماتیک MTU برداشته شد. از این به بعد خودتان به صورت manual وارد نمایید.**

**تنها Geneve تستش مانده است که به زودی تستش میکنم**

**پنج سرور ایران و ده سرور‌ خارج هم اضافه میکنم**
