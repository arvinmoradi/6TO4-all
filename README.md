...
**ویرایش ایپی های لوکال‌ برای روش های پر استفاده، اضافه خواهد شد که مشکل قطعی شما را حل میکند**
...
**در گزینه 7، 30 ثانیه برای reconfig صبر میکند اما در گزینه 6 reconfig بدون وقفه انجام میشود**( ممکن است اشتباهاتی در این ریست تایمر باشد که به من میتونید گزارش بدهید)
