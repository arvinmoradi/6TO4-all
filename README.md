...
**ربات ریکانفیگ مولتی ، ip6ip6 و ip6ip6 IPSEC اپدیت شد**

**ربات ریکانفیگ برای سرورهایی میباشد که مشکل قطعی لوکال در هر چند ساعت را دارند و تنها با reconfig مشکلشان حل میشود**
